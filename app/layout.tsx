...
// Forntox body font: --font-body in globals.css resolves to it (and
// --font-sans follows --font-body), so it loads on every host.
...
export default async function RootLayout({
  ...
  return (
    <html
      ...
      className={`${geistSans.variable} ${geistMono.variable} ${hedvigSerif.variable} ${figtree.variable} ${brandFontVariables}`}
      style={
        fontPair
          ? ({
